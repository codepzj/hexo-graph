        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                if(heatmapChartDom){
                    ...
                    const containerWidth = heatmapChartDom.offsetWidth;
                    const cellSize = Math.max(Math.floor(containerWidth / 58), 10);
                    var year = heatmapChartDom.getAttribute('year') || new Date().getFullYear();
                    ...
                    heatmapChart.setOption({
                        ...
                        visualMap: { min: 0, max: Math.max(...${data}.map(item => item[1])), orient: 'horizontal', right: '5%', bottom: '5%', inRange: { color: ${JSON.stringify(
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                if(monthlyChartDom){
                    ...
                    monthlyChart.setOption({
                        xAxis: { type: 'category', data: ${months}, axisLabel: { fontSize: 14, fontWeight: 'bold', fontFamily: 'Microsoft YaHei, SimSun, serif' } },
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                if(categoriesChartDom){
                    ...
                    categoriesChart.setOption({
                        ...
                        yAxis: { type: 'category', data: ${categories}.map(category => category.name).reverse(), axisLabel: { fontSize: 14, fontWeight: 'bold', fontFamily: 'Microsoft YaHei, SimSun, serif' } },
                        series: [{
                            name: 'Category Count',
                            type: 'bar',
